 ...
 */
interface SubscriberFlowControlLike {
 ...
 */
interface SubscriberPubSubLike {
    /**
    ...
    subscription(name: string, options?: {
        flowControl?: SubscriberFlowControlLike;
    }): SubscriptionLike;
}

export type { AckableMessage as A, PubSubLike as P, SubscriberFlowControlLike as S, TopicLike as T, SubscriberPubSubLike as a, SubscriptionLike as b };
